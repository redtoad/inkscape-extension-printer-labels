...
LABELS = [
    ...
    ("HERMA No. 4587", Label((210.0, 297.0), "mm", (80.0, 50.0), (2, 5), offset=(18.0, 14.0), spacing=(15.0, 4.75), corner_radius=3.0)),
]
# fmt: on
    ...
    def set_namedview(self, width, height, units):
        ...
        if self.options.add_shapes:
            ...
            for shape in self.specs.get_shapes():
                group.add(shape)
            group.set("{%s}insensitive" % inkex.NSS["sodipodi"], "true")  # lock group
