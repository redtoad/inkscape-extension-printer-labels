...
class TestLabel:
    ...
    def test_label_creation_default(self):
    ...
    def test_get_guides_no_offset(self):
    ...
    def test_get_guides_with_offset(self):
    ...
    def test_get_guides_with_spacing(self):
    ...
    def test_get_shapes_rectangular(self):
    ...
    def test_get_shapes_circular(self):
    ...
    def test_get_shapes_with_offset_and_spacing(self):
    ...
    def test_get_shapes_invalid_type(self):
    ...
    def test_get_shapes_positions(self):
